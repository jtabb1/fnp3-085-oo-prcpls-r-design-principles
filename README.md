...
The study of and refinement of the principles of object-oriented design will
...
In the above method, we are using an if/elsif statement to determine what kind
